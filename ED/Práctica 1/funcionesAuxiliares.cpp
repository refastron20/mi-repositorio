...
int ed::menu()
{
 int opcion, posicion;
  ...
  PLACE(posicion++, 10);
  std::cout << "[3] Funciones Extra, derivada, integral y potencia" << '\n';
...
void ed::testExtra(){
    ...
    std::cout<< RESET;
  	...
  	/////////////////
  	std::cout << BIGREEN;
  	std::cout<< "Los monomios son: " << std::endl;
  	std::cout << RESET;
    ...
    //Integral, derivada y potencia
    std::cout << BIGREEN;
    std::cout<< "Integral, derivada y potencia " << std::endl;
    std::cout << RESET;
    ...
    //Funciones de concatenación y cálculo de polinomios
    std::cout<<BIGREEN;
    std::cout << "Funciones de concatenación y cálculo de polinomios" << '\n';
    std::cout<<RESET;

    std::cout << "Concatenación de m1+m2+m3" << '\n';
    ...
    std::cout<<BIGREEN;
    std::cout << "Introduzca los monomios m1 y m2 para su cálculo" << '\n';
    std::cout<<RESET;

    std::cout<<BIRED;
    std::cout << "Recuerde que si m1 no es de grado 2 y m1 de grado 1 no podrá realizar los cálculos" << '\n';
    std::cout<<RESET;
    ...
    std::cout << "Cálculo de ";m1.escribirMonomio();std::cout<<" + ";m2.escribirMonomio();std::cout<<" + " <<x<< '\n';
    calcularPolinomio2(m1, m2, x);
    std::cout << "Cálculo de ";m1.escribirMonomio();std::cout<<" + " <<x<< '\n';
    calcularPolinomio2(m1, x);
    std::cout << "Cálculo de ";m2.escribirMonomio();std::cout<<" + " <<x<<'\n';
    calcularPolinomio2(m2, x);
